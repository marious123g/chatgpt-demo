...
export default () => {
  ...
  const handleButtonClick = async() => {
    console.log('this is handleBtnClick')
  ...
  const requestWithLatestMessage = async() => {
    ...
    try {
      ...
      console.log('this is generator.tsx, preparing to generate request...')
      ...
      if (!response.ok) {
        console.log('request failed, plz check your proxy or api key')
